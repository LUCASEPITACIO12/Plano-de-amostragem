...
#    app.py  |  calculos.py  |  excel_export.py
#    test_calculos.py  |  requirements.txt
...
| `test_calculos.py` | Testes automatizados (pytest) da lógica regulatória |
...
```bash
pip install pytest
python -m pytest test_calculos.py -v
```
